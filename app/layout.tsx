...
export const metadata: Metadata = {
  ...
  openGraph:{title:"Cécile Gimenez · Psyché · Corps · Conscience",description:"Un espace de parole, de conscience et de transformation à Fréjus et en ligne.",type:"website",locale:"fr_FR",images:[{url:"/og.png",width:1734,height:907,alt:"Cécile Gimenez — Psychanalyste et Sophrologue à Fréjus"}]},
