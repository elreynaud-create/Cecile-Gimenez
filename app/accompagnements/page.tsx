...
const items = [
  ...
  ["specialites","05","Spécialités","Accueillir ce qui demande à changer","Anxiété, stress et surcharge mentale · Troubles du sommeil · États dépressifs et épuisement · Traumatismes et mémoire du corps · Deuils, séparations et passages de vie · Répétitions, blocages et difficultés relationnelles · Manque de confiance et perte de repères · Manifestations psychosomatiques · Accompagnement des enfants, adolescents et adultes."]
];
